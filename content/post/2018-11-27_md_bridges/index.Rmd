...
```{r tt_mabrdl, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
tt_balt_gh <-
...
Peak bridge-biulding in Maryland was 19502 through 1990s, with a significant drop since then. 

```{r tt_mdbr01, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
tt_mdbrdf %>% 
  mutate(county = str_replace(county, " County", "")) %>%
  count(decade_built) %>%
...
```{r tt_mdbr02, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_mdbr03, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_mdbr04, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_mdbr05, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_mdbr06, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_mdbr07, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_mdbr08, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_mdbr09, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
