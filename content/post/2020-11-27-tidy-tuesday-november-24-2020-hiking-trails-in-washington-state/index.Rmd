---
title: Tidy Tuesday, November 24, 2020 - Hiking Trails in Washington State
author: Greg Dubrow
date: '2020-11-27'
slug: tidy-tuesday-november-24-2020-hiking-trails-in-washington-state
...
tags:
  ...
  - tidytuesday
subtitle: ''
summary: 'Exploring the #tidytuesday dataset for 11-24-2020'
authors: []
#lastmod: '2020-11-27T22:52:49-08:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
Well, this week, with some slack time and some inspiration I finally got around to it. A resulting benefit was it got me motivated to finally get around to getting this blog set up. 

Anyway, here's the code and resulting charts. I've also got a [github repo](https://github.com/greg-dubrow/) set up for [tidytuesday projects](https://github.com/greg-dubrow/tidy-tuesday-projects). Right now the only other completed work is the Maryland brdige set from 2018, that I only got around to finishing in March of 2020 during my week between job. Thought I'd get the blog set up then, but started a new job, pandemic lockdown and stresses...a post on that set coming soon, but you can always check out the [results on github](https://github.com/greg-dubrow/tidy-tuesday-projects/tree/master/2018/tt_2018-11-27_md_bridges).
...
```{r tt_watrdl, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_watrdf, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r tt_watr01, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE }
hist_length <-
tt_watraildf %>%
...
```{r tt_watr02, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE }
...
```{r tt_watr03, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE}
tt_watraildf %>%
  distinct(name, .keep_all = TRUE) %>%
  filter(gain > 15000) %>%
...
```{r  tt_watr04, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE }
...
```{r tt_watr05, fig.width=7.5, fig.height=4.0, dpi = 300, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE }
...
```{r tt_watr06, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE }
