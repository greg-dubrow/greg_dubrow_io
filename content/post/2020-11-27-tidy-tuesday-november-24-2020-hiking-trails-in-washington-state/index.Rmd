...
Well, around Thanksgiving, with some slack time and some inspiration, I finally got around to it. A resulting benefit was it got me motivated to finally get around to getting this blog set up. 

Here's the code and resulting charts & tables. I've got a [github repo](https://github.com/greg-dubrow/) set up for [tidytuesday projects](https://github.com/greg-dubrow/tidy-tuesday-projects). 
...
```{r tt_watr07, echo = TRUE, warning=FALSE, message = FALSE, error= FALSE }
