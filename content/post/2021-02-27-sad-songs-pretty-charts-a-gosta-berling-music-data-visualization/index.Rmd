...
author: Greg Dubrow
date: '2021-02-28'
slug: gosta-berling-music-data-visualization
categories:
  - post
tags:
  - rstats
  ...
  - spotify
subtitle: ''
summary: 'Using Spotify data to visualize music by Gosta Berling'
authors: []
...
![spotifyrev](images/gb_spotify_revenue.png)
...
```{r pkgload, message=FALSE, ECHO = FALSE}
...
```{r gbaudio2, ECHO = TRUE, eval = FALSE}
...
```{r gbaudio3, ECHO = TRUE, eval = FALSE}
...
```{r datasummary, echo = FALSE, warning=FALSE, message = FALSE, error= FALSE}
gosta_audio %>%
...
```{r gbcorr1, ECHO = FALSE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r gbcorr2, fig.width=7.5, fig.height=4.0, dpi = 300,  ECHO = FALSE, warning=FALSE, message = FALSE, error= FALSE}
cor(gbcorr)
...
```{r gbcorr3, fig.width=8, fig.height=4.0, dpi = 300, ECHO = FALSE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r gbcorr4, fig.width=7.5, fig.height=4.0, dpi = 300, ECHO = FALSE, warning=FALSE, message = FALSE, error= FALSE}
gbcorr %>%
  correlate(use = "pairwise.complete.obs", method = "spearman")
```

Next, I used their rplot call and then rendered a network graph using the network_plot() call.
```{r gbcorr5, fig.width=8, fig.height=4.0, dpi = 300, ECHO = FALSE, warning=FALSE, message = FALSE, error= FALSE}
...
```{r dataviz1, fig.width=8.0, fig.height=4.0, dpi = 300, warning=FALSE, message = FALSE, error= FALSE}
gosta_audio %>%
...
```{r dataviz2, fig.width=8.0, fig.height=4.0, dpi = 300, echo = FALSE, warning=FALSE, message = FALSE, error= FALSE}
gosta_audio %>%
...
```{r dataviz3, fig.width=8.0, fig.height=4.0, dpi = 300, echo = FALSE, warning=FALSE, message = FALSE, error= FALSE}
gosta_audio %>%
