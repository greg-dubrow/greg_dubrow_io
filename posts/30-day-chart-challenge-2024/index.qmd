...
#| code-overflow: scroll
#| code-fold: true
#| code-summary: "Show code for circular time plots - hour"
...
#| code-overflow: scroll
#| code-fold: true
#| code-summary: "Show code for circular time plots - minute"
...
*Please note that in November 2024 Spotify deactivated many API end points, including the ones I demo in this post and in the [Spotify post from February 2021](https://www.gregdubrow.io/posts/sad-songs-pretty-charts-a-gosta-berling-music-data-visualization/). They are still dead as of late March 2025, and I have no idea when or if they will reactivate the API end points.*
...
#| code-overflow: scroll
#| code-fold: true
#| code-summary: "Show code for getting playlist data - pt1"
...
#| code-overflow: scroll
#| code-fold: true
#| code-summary: "Show code for getting playlist data - pt2"
...
#| code-overflow: scroll
#| code-fold: true
#| code-summary: "Show code for getting playlist data - pt3"
...
#| code-overflow: scroll
#| code-fold: true
#| code-summary: "Show code for getting visualisation data ready"
...
# quietly load data into environment
...
#| code-overflow: scroll
#| code-fold: true
#| code-summary: "Show code for audio features plot 1"
...
#| code-overflow: scroll
#| code-fold: true
#| code-summary: "Show code for audio features plot2-4"
