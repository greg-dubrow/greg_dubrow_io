...
[![](lyon_jardincuriosities_170922.jpeg){width="70%" fig-align="left" fig-alt="Lyon from the Jardin des Curiosité."}](https://www.flickr.com/photos/dannebrog/52366141948)
...
To read about the migration details, go [here](https://www.gregdubrow.io/posts/migrating-from-hugo-to-quarto/). All of the old posts are up, time-stamped with the original posting dates. And hopefully soon, new posts as I work through a fairly long list of project ideas and try to get back to working on [#tidytuesday](https://github.com/rfordatascience/tidytuesday) datasets.
