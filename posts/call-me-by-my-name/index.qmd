...
So there you go. There's much more to do...download the most recent sets, match names to regions and states. Look at other countries either through r packages like [`ukbabynames`](https://mine-cetinkaya-rundel.github.io/ukbabynames/) or usepackages or API calls to national statistical services.
