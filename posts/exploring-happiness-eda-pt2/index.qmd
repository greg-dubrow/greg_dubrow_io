...
That's it for basic EDA on the data. The next post will dig a bit deeper...look at some differences by region, and I'll try to predict happiness score and see how close I can get to the WHR model.
